...
9. Any customer-specific examples, screenshots, or audit findings are factual and checked.

## Follow-up email

Subject: Proposal for [Race Name]’s new website
...
A fast, SEO-optimized race website designed to help runners:

- Find the race through search
- Trust the race details quickly on mobile
...
Customer-owned delays pause the delivery clock.
...
Once the deposit is paid, we’ll send the intake form and asset checklist and start the kickoff process.
