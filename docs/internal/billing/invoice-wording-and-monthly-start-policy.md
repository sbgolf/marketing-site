...
Use this as the default invoice memo/description for the final 50% setup balance:
...
## Final invoice email note

Use this short note when the Stripe invoice is sent:

```text
[First Name],

Your [Race Name] site is live at [Live URL].

I just sent the final 50% setup invoice through Stripe:

- Package: StartLine Sites [Starter / Standard / Premium]
- Final setup balance: $[Amount]
- Terms: Net 7
- Due date: [Due Date]
